 ...
 * <p>
 * 独立XML应用程序上下文，从类路径中获取上下文定义文件，将纯路径解释为包含包路径的类路径资源名称（例如“ mypackage / myresource.txt”）。
 * 对于测试工具以及JAR中嵌入的应用程序上下文很有用。
 *
...
public class ClassPathXmlApplicationContext extends AbstractXmlApplicationContext {
	 ...
	 *
	 * 创建一个新的ClassPathXmlApplicationContext对象，从给定的XML文件中加载定义，并自动刷新上下文。
	 *
